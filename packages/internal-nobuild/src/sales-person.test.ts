  ...
  describe("lookUpSalesPersonForZipcode", () => {
    const salesPersons: SalesPersonDirectory = [
      ...
      },
      {
        ...
        email: "philippe@mosque-icu.com",
      },
      {
        name: "lance",
        email: "lance@mosque-icu.com",
        regexp:
          /^76|^27|^78|^95|^94|^93|^92|^91|^45|^28|^41|^37|^72|^61|^14|^50|^35|^56|^22|^29|^44|^49|^53/,
      },
      {
        name: "john",
        email: "john@mosque-icu.com",
        regexp: /^974|^976/,
      },
      {
        name: "mike",
        email: "mike@mosque-icu.com",
